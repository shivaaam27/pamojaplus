...
export default function AboutPage() {
  return (
    <>
      ...
      <Section className="relative">
        ...
        <Container>
          ...
          <h1 className="mt-4 font-display font-extrabold text-4xl sm:text-6xl leading-[1.05] text-balance">
            <WordReveal text="More than a marketplace." /><br />
            <WordReveal text="A " />
            <GradientText>digital movement.</GradientText>
          </h1>
          <Reveal delay={0.4}>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <MagneticButton href="/marketplace" variant="primary">Explore the marketplace</MagneticButton>
              <MagneticButton href="/sellers/apply" variant="ghost">Join as a seller</MagneticButton>
            </div>
          </Reveal>
        </Container>
      </Section>
      ...
      {/* MARQUEE */}
      <Marquee items={["Grow Together", "Shop Smarter", "Pamoja", "Discover Local", "Save More", "Rise Collectively"]} />
      ...
      <Section>
        <Container>
          ...
          <StaggerGroup className="grid sm:grid-cols-2 md:grid-cols-4 gap-4" stagger={0.04}>
            {[
          ...
          <Reveal>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="flex gap-3 flex-wrap">
                <MagneticButton href="/sellers/apply" variant="primary">Join as a seller</MagneticButton>
